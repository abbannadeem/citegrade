      ...
      <main className="flex-1 px-6 py-20">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-4">
            <Link
              href="/pricing"
              className="rounded-xl border border-line bg-surface hover:bg-surface2 hover:border-primary/40 px-5 py-4 transition-colors group"
            >
              <p className="text-fg font-medium">Pricing</p>
            ...
            <Link
              ...
              className="rounded-xl border border-line bg-surface hover:bg-surface2 hover:border-primary/40 px-5 py-4 transition-colors group"
            >
              <p className="text-fg font-medium">Changelog</p>
              <p className="text-sm text-muted mt-1">
