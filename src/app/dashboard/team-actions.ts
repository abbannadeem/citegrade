...
export async function inviteMemberAction(formData: FormData) {
  ...
  await sendEmail({
    ...
    html: `<p>${user.name} added you to their team "<strong>${team.name}</strong>" on Citegrade.</p><p><a href="${siteUrl("/dashboard/team")}">Open Citegrade</a> — sign in with this email to see shared audits.</p>`,
