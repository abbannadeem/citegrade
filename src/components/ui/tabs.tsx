...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 h-8 text-xs font-medium tracking-tight text-zinc-400 transition-all hover:text-zinc-200",
